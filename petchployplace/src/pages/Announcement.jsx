...
function Announcements() {
  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', paddingBottom: '40px', position: 'relative' }}>
      ...
      {/* เพิ่มเงื่อนไขตรวจสอบข้อมูลตรงนี้ */}
      {announcements.length === 0 ? (
        <div style={{ 
          ...
          <div style={{ fontSize: '50px', marginBottom: '15px', opacity: '0.8' }}>📭</div>
          <h3 style={{ fontSize: '18px', fontWeight: '500', color: '#555555', margin: '0 0 8px 0' }}>
            ยังไม่มีประกาศ
          </h3>
          <p style={{ fontSize: '14.5px', color: '#888888', fontWeight: '300', margin: 0 }}>
            หากมีประกาศสำคัญหรือการอัปเดต จะแจ้งให้ทราบในส่วนนี้
          </p>
        </div>
      ) : (
